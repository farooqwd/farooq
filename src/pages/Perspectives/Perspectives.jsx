          ...
          <div className="data-table-container card">
            <table className="data-table">
              <thead>
                <tr>
                  <th>
                    Document Number <i className="fas fa-sort"></i>
                  </th>
                  <th>
                    Document Name <i className="fas fa-sort"></i>
                  </th>
                  <th>
                    Document Lead <i className="fas fa-sort"></i>
                  </th>
                  <th>
                    Document Preparer <i className="fas fa-sort"></i>
                  </th>
                  <th>
              ...
              <tbody>
                {documents.map((doc, index) => (
                  <tr key={index}>
                    ...
                    <td data-label="Document" className="doc-name">
                      {doc.name}
                    </td>
